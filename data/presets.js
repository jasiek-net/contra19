...
export const PRESET2 = {
  ...
  removeWinning: true,
  prizes: [
    { name: 'Wesprzyj lokalny biznes', freq: 4, bg: '#FFCC80', text: '#222', hide: false, fontMod: 1 },
    { name: 'Walcz z fake newsami', freq: 4, bg: '#F48FB1', text: '#222', hide: false, fontMod: 1 },
    { name: 'Zorganizuj imprezę online', freq: 4, bg: '#81D4FA', text: '#222', hide: false, fontMod: 1 },
    { name: 'Zadbaj o jakość nauki online', freq: 4, bg: '#B39DDB', text: '#222', hide: false, fontMod: 1 },
    { name: 'Zorganizuj czas najmłodszych', freq: 4, bg: '#C5E1A5', text: '#222', hide: false, fontMod: 1 },
    { name: 'Uratuj teatry', freq: 4, bg: '#F48FB1', text: '#222', hide: false, fontMod: 1 },
    { name: 'Zaoferuj e-korepetycje', freq: 4, bg: '#81D4FA', text: '#222', hide: false, fontMod: 1 },
    { name: 'Pomóż sąsiadom', freq: 4, bg: '#FFCC80', text: '#222', hide: false, fontMod: 1 },
    { name: 'Zaplanuj życie po koronawirusie', freq: 4, bg: 'white', text: '#222', hide: false, fontMod: 1 },
  ]
};
